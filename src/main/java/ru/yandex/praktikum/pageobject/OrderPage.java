...
public class OrderPage {
    ...
    private final By orderMetroStationField = By.xpath(".//input[@placeholder='* Станция метро']");
    ...
    //
    public void addUserInfoInOrder(String userName, String userSurname, String address, String metroStation, String phone) {
